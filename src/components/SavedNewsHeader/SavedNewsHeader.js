...
export default function SavedNewsHeader({
  ...
  return (
    <header className="header header_type_in-saved-news">
      <Link to="/main" className="header__logo header__logo_type_in-saved-news">
        NewsExplorer
      </Link>
      <Navigation
        isLoggedIn
      ...
      <button
        ...
        className={`header__nav-button header__nav-button_type_in-saved-news ${
          isMobileNavigationActive
            ? "header__nav-button_mode_saved-news-esc-mode"
            : ""
        }`}
      />
    </header>
