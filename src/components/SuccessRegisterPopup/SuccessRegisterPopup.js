...
function SuccessRegisterPopup({ isPopupOpen, onRelativePathClick, onClose }) {
  ...
  return (
    <div
      className={`popup popup_type_success-register ${
    ...
    >
      <div className="popup__content popup__content_type_success-register">
        <div className="popup__head">
          ...
          <button
            className="popup__esc popup__esc_type_success-register"
            onClick={onClose}
          />
        </div>
        <button
